...
def call_sockeye_train(model: str,
    ...
    fnames = ["--source={}".format(os.path.join(bpe_dir, PREFIX_TRAIN + SUFFIX_SRC_GZ)),
              ...
              "--alignment={}".format(alignment_path),
              ...
              "--val-alignment={}".format(val_alignment_path),
...
def call_sockeye_translate(args: List[str],
    ...
    args.append("--attn-type={}".format(attn_type))
    # Assemble command
...
def run_steps(args: argparse.Namespace):
    ...
    if os.path.exists(complete_fname):
        ...
        call_sockeye_train(args.model,
                           ...
                           args.gpus,
                           os.path.abspath(args.custom_aln[0]),
                           os.path.abspath(args.custom_aln[1]),
                           test_mode=args.test,)
...
def main():
    ...
    arg_parser.add_argument("--custom-aln", nargs=2, metavar=("aln val-aln"), type=str, help="Custom alignment file and validation alignment file")
    ...
    arg_parser.add_argument("--attn-type", type=str, default="enc")
