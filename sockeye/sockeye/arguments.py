...
def add_training_data_args(params, required=False):
    ...
    params.add_argument(C.TRAINING_ARG_ALIGNMENT, '-a', required=required, type=regular_file(), help='alignment file for parallel training data')
...
def add_validation_data_params(params):
    ...
    params.add_argument('--val-alignment', '-vas',
                        required=False,
                        type=regular_file(),
                        help='Alignment for validation data')
...
def add_training_args(params):
    ...
    train_params.add_argument('--loss',
                              ...
                              choices=[C.CROSS_ENTROPY, C.CROSS_ENTROPY_ALIGNMENT],
...
def add_inference_args(params):
    ...
    decode_params.add_argument('--attn-type',   
                                default="enc",
                                type=str,
                                choices=['enc', 'avg'],
                                help='type of attention used for alignment. enc is attention over only the encoder states, avg is averaged self-attention across all layers. Default: %(default)s')
