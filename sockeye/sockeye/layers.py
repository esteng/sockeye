...
class MultiHeadAttentionWithProbs(MultiHeadAttention):
    ...
    def _attend(self,
        ...
        # @Matt this is where the target_len dimension gets removed 
        # possible that this is wrong, he could be compressing length and heads into length*heads where length != 1 and not know about it since heads gets averaged out later
